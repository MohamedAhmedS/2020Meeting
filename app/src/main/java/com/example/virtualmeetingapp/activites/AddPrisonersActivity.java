...
public class AddPrisonersActivity extends BaseActivity {
    ...
    @Override
    public void initXML() {
//        phoneAddPrisoners = findViewById(R.id.phoneNumberAddPrisoner);
        nameAddPrisoners = findViewById(R.id.nameAddPrisoner);
//        emailAddPrisoners = findViewById(R.id.emailAddPrisoners);
        emailAddPrisoner = findViewById(R.id.emailAddPrisoner);
        passwordAddPrisoners = findViewById(R.id.passwordAddPrisoner);
        descriptionAddPrisoners = findViewById(R.id.descriptionAddPrisoner);
        btnAddPrisoners = findViewById(R.id.btnAddPrisoner);
//        ccpAddPrisoners = (CountryCodePicker) findViewById(R.id.ccpAddPrisoner);
