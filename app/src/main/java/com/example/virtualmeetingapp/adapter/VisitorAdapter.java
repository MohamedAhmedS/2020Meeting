...
public class VisitorAdapter extends RecyclerView.Adapter<VisitorAdapter.ViewHolder> {
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, int position) {
        ...
        if (!currentUser.getUserType().equals(Constants.USER_TYPE_ADMIN)) {
        ...
        if (!currentUser.getUserType().equals(Constants.USER_TYPE_OFFICER)) {
            ...
            holder.btnAprOffList.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View v) {
            ...
            holder.btnAprPriList.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View v) {
